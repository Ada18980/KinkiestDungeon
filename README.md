...
## Atlases
After making any changes to the images in the game, you will need to repack the texture atlases. This can be done by running the pack_windows.bat or pack_linux.sh (TODO) script in the tools folder.
