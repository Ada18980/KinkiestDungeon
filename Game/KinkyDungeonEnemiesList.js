...
let KinkyDungeonEnemies = [
	...
	{name: "AlchemistPet", faction: "Alchemist", clusterWith: "alchemist", bound: "AlchemistPet", color: "#007C59", tags: KDMapInit(["opendoors", "submissive", "noshop", "gagged", "imprisonable", "ignorenoSP", "alchemist", "ranged", "glueweakness", "ticklesevereweakness", "slashweakness", "pierceweakness", "search"]), ignorechance: 0, armor: 0, followRange: 2, AI: "hunt",
		...
		dropTable: []},
	{name: "WolfgirlPet", faction: "Nevermere", clusterWith: "wolfgirl", bound: "WolfgirlPet", color: "#009C79", tags: KDMapInit(["opendoors", "submissive", "noshop", "gagged", "wolfPet", "alwaysAlert", "imprisonable", "wolfgirl", "ignorenoSP", "alchemist", "ranged", "glueweakness", "ticklesevereweakness", "slashweakness", "pierceweakness", "search"]), ignorechance: 0, armor: 0, followRange: 2, AI: "hunt",  cohesion: 0.9,
		...
		dropTable: []},
	{name: "WolfGuard", faction: "Nevermere", clusterWith: "wolfgirl", bound: "WolfGuard", color: "#00dCa9", tags: KDMapInit(["opendoors", "submissive", "noshop", "gagged", "wolfPet", "autoTape", "alwaysAlert", "leashing", "wolfLeash", "imprisonable", "wolfgirl", "ignorenoSP", "alchemist", "ranged", "glueweakness", "ticklesevereweakness", "slashweakness", "pierceweakness", "search"]),
		...
		terrainTags: {"metalAnger": 1.5, "metalRage": 8, "wolfgirl": 1}, shrines: ["Metal"], allFloors: true,
	...
	{name: "WolfInstructor", faction: "Nevermere", clusterWith: "wolfgirl", bound: "Wolfgirl", color: "#00EFAB", tags: KDMapInit(["leashing", "imprisonable", "trainer", "controlHarness", "wolfgirl", "jailer", "opendoors", "unflinching", "closedoors", "wolfGear", "handcuffer", "melee", "miniboss", "unflinching", "charmweakness", "ticklesevereweakness", "jail", "hunter"]),
		...
		terrainTags: {"secondhalf":4, "lastthird":4, "metalAnger": 11, "metalRage": 4, "wolfgirl": 9}, allFloors: true, shrines: ["Metal"],
	...
	{name: "WolfDrone", faction: "Nevermere", clusterWith: "wolfgirl", color: "#00EFAB", playLine: "Robot",
		tags: KDMapInit(["ignoreharmless", "doortrap", "robot", "wolfdrone", "flying", "acidweakness", "soulresist", "minor", "ranged", "electricsevereweakness", "wolfPet", "coldresist", "iceresist", "slashresist", "crushsevereweakness", "pierceweakness", "hitechCables", "cableGag", "jail", "search"]),
