...
let KinkyDungeonStatsPresets: Record<string, KDPerk> = {
	...
	"StrugglePerLevel": {category: "Kinky", id: "StrugglePerLevel", cost: 3, block: ["StrugglePerLevelNeg"]},
	"StrugglePerLevelNeg": {category: "Kinky", id: "StrugglePerLevelNeg", cost: -3, block: ["StrugglePerLevel"]},
	"EasierBlindfolds": {category: "Kinky", id: "EasierBlindfolds", cost: 2.5},
	"PainfulChoice": {category: "Kinky", id: "PainfulChoice", cost: 0, debuff: true},
