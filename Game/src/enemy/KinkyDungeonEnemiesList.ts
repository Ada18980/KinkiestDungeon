...
let KinkyDungeonEnemies: enemy[] = [
	...
	{name: "PrettyDoll", bound: "PrettyDoll", playLine: "Gagged", tags: KDMapInit(["prisoner",
		"nocapture", "dressconvert", "doll", "human", "minor", "peaceful", "nohelp", "noshop"]),
		rescueTo: {
			Remove: "FreeDoll",
			Unlock: "FreeDoll",
		},
		...
		Behavior: {noPlay: true},
		terrainTags: {"dressDoll": 20}, allFloors: true},
	...
	{name: "DragonLeaderDuelist", nameList: "demon", outfit: "RebelScum", style: "Earth", faction: "Enemy", bound: "DragonLeader", color: "#F92900",
		...
		visionRadius: 7, maxhp: 28, minLevel:0, weight:-1000, movePoints: 2, attackPoints: 2, attack: "MeleeBindLockWill", attackWidth: 1, attackRange: 1, power: 4, dmgType: "crush", fullBoundBonus: 2,
		 shrines: ["Leather"], allFloors: true,
	...
	{name: "BlindZombie", pronouns: {It: 100}, bound: "Zombie", style: "Zombie", outfit: "Zombie", playLine: "Zombie", clusterWith: "zombie", tags: KDMapInit(["ignoretiedup", "nocapture", "minor", "zombie", "melee", "fireweakness", "ribbonRestraints", "meleeweakness"]),
	...
	{name: "FastZombie", pronouns: {It: 100}, bound: "Zombie", style: "Zombie", outfit: "Zombie", playLine: "Zombie", clusterWith: "zombie", tags: KDMapInit(["ignoretiedup", "nocapture", "zombie", "melee", "fireweakness", "ribbonRestraints", "meleeweakness"]),
	...
	{name: "SummonedZombie", pronouns: {It: 100}, bound: "Zombie", style: "Zombie", outfit: "Zombie", playLine: "Zombie", clusterWith: "zombie", tags: KDMapInit(["ignoretiedup", "nocapture", "zombieTrap", "zombie", "melee", "fireweakness", "ribbonRestraints", "meleeweakness", "temporary", "nocapture"]),
	...
	{name: "MageZombie", pronouns: {It: 100}, bound: "MageZombie", style: "Zombie", outfit: "Zombie", playLine: "Zombie", clusterWith: "zombie",
		tags: KDMapInit(["leashing", "zombie", "ranged", "zombieTrap", "fireweakness", "ribbonRestraints", "meleeweakness", "hunter"]),
		...
		visionRadius: 6, maxhp: 11, minLevel:2, weight:28, movePoints: 3, attackPoints: 4, attack: "SpellMeleeBindLock", attackWidth: 1, attackRange: 1, power: 1, dmgType: "grope", fullBoundBonus: 2,
		attackLock: "Purple",
		terrainTags: {"zombieTrap": 25}, floors:KDMapInit(["grv", "tmb"]), dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 10}]},
	{name: "TalismanZombie", pronouns: {It: 100}, bound: "TalismanZombie", style: "Zombie", outfit: "Zombie", playLine: "Zombie", clusterWith: "zombie", tags: KDMapInit(["leashing", "zombie", "zombieTrap", "ranged", "fireweakness", "ribbonRestraints", "meleeweakness", "hunter"]),
		...
		visionRadius: 6, maxhp: 20, minLevel:3, weight:34, movePoints: 3, attackPoints: 4, attack: "SpellMeleeBindLock", attackWidth: 1, attackRange: 1, power: 1, dmgType: "grope", fullBoundBonus: 2,
		attackLock: "Purple",
		events: [
			{trigger: "getLights", type: "enemyTorch", power: 3, color: "#ffff44"},
		],
		terrainTags: {"mummy": 3, "zombieTrap": 10}, floors:KDMapInit(["grv", "tmb"]), dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 10}]},
	{name: "SamuraiZombie", pronouns: {It: 100}, bound: "SamuraiZombie", style: "Zombie", outfit: "Zombie", playLine: "Zombie", clusterWith: "zombie",
	...
	{name: "MaidforceStalkerImage", faction: "Maidforce", color: "#814BB7", tags: KDMapInit(["ghost", "maid", "melee"]), followLeashedOnly: true, blindSight: 12, followRange: 2, AI: "hunt", guardChance: 0.6, projectileAttack: true, evasion: -10,
		...
		visionRadius: 7, maxhp: 1, minLevel:0, weight:-10, movePoints: 1.25, attackPoints: 2, attack: "MeleeWill", attackWidth: 1, attackRange: 1, tilesMinRange: 1, power: 1, dmgType: "grope",
		 shrines: ["Illusion"], floors:KDMapInit([]),},
	...
	{name: "MaidforceHead", nameList: "bountyhunter", faction: "Maidforce", bound: "MaidforceHead", outfit: "MaidforceHead", style: "Maid", clusterWith: "maid", color: "#814BB7", playLine: "HeadMaid", tags: KDMapInit(["leashing", "antiMagic", "guardCall", "tickleweakness", "opendoors", "human", "maid", "unflinching", "boss", "ranged", "maidRestraintsHeavy", "maidRestraintsNonChastity", "maidVibeRestraints", "handcuffer", "jailer", "hunter"]), followLeashedOnly: true, followRange: 3.5, AI: "hunt", guardChance: 0.6, projectileAttack: true,
		spells: ["AmpuleGreen", "Hairpin", "RestrainingDevice"], spellCooldownMult: 1, spellCooldownMod: 0,  disarm: 1, ignoreStaminaForBinds: true, sneakThreshold: 1, focusPlayer: true,
	...
	{name: "Ghost", color: KDBaseWhite, faction: "Ghost", clusterWith: "ghost", tags: KDMapInit(["illusionTrap", "ghost", "flying", "spooky", "melee", "minor", "glueimmune", "chainimmune", "magicweakness"]),
		ethereal: true, ignorechance: 0, armor: 0, followRange: 1, AI: "hunt", guardChance: 0.6, 
	...
	{name: "TickleTerror", faction: "Ghost", color: KDBaseWhite, tags: KDMapInit(["illusionTrap", "chestTrap", "ignorenoSP", "comfyRestraints", "spooky", "ghost", "flying", "melee", "glueimmune", "chainimmune", "meleeresist", "magicweakness"]), ethereal: true, ignorechance: 0, armor: 0, followRange: 1, AI: "hunt",  noAlert: true, 
	...
	{name: "TickleHand", hidetimerbar: true, faction: "Witch", clusterWith: "ghost", color: KDBaseWhite, tags: KDMapInit(["ignorenoSP", "ghost", "flying", "melee", "glueimmune", "chainimmune", "magicweakness"]),
		ethereal: true, ignorechance: 0, armor: 0, followRange: 1, AI: "hunt",  regen: -0.1, noAlert: true, 
	...
	{name: "TickleHandSlave", faction: "Witch", color: KDBaseWhite, tags: KDMapInit(["ignorenoSP", "ghost", "flying", "melee", "glueimmune", "chainimmune", "magicweakness"]),
		...
		master: {type: "ConjurerTickler", range: 3, dependent: true}, noAlert: true, 
		visionRadius: 10, blindSight: 3, evasion: 9.0, alwaysEvade: true, maxhp: 1, minLevel:0, weight:-1000, movePoints: 2, attackPoints: 1, attack: "MeleeWill", attackWidth: 3, attackRange: 1, power: 3, dmgType: "tickle", fullBoundBonus: 0,
		events: [
			{trigger: "getLights", type: "enemyTorch", power: 1, color: KDBaseWhite},
		],
	...
	{name: "VineSpitter", faction: "Plant", clusterWith: "plant", color: "#4fd658", blockVisionWhileStationary: true,
		...
		kite: 1.5,
		stamina: 3,
		visionRadius: 5, ambushRadius: 2.5, blindSight: 5, maxhp: 10, minLevel:0, weight:-5, movePoints: 1.8, attackPoints: 2, attack: "SpellMeleeBind", attackWidth: 1, attackRange: 1, power: 2, dmgType: "crush", fullBoundBonus: 3,
		terrainTags: {"passage": -50, "adjChest": 8, "door": 12, "elf": 5, slime: 30, lightslime: 12, "nature": 5}, floors:KDMapInit(["jngWild"]), shrines: ["Rope", "Will"]},
	...
	{name: "RedSlime", faction: "Alchemist", clusterWith: "alchemist", color: KDBaseRed, hidetimerbar: true, tags: KDMapInit(["ignoretiedup", "disarmimmune", "blindresist", "ignoregagged", "experiment", "slime", "melee", "minor", "ballGagRestraints", "meleeresist", "chainimmune", "electricresist", "iceweakness"]),
		...
		visionRadius: 4.5, maxhp: 3.2, minLevel: 5, weight:10, movePoints: 2, attackPoints: 3, attack: "SpellMeleeSlowBindSuicide", suicideOnSpell: true, suicideOnAdd: true, attackWidth: 1, attackRange: 1, power: 1, dmgType: "crush",
		 floors:KDMapInit(["tmp"]), shrines: ["Latex"]},
	...
	{name: "Cyborg", faction: "AncientRobot",
		...
		tags: KDMapInit(["leashing", "opendoors", "closedoors", "jail", "jailer", "melee", "unflinching", "elite", "robot",
			"cyborg", "cyberdollrestraints", "cyberhogtie", "cyberdollheavy", "controlharness", "handcuffer",
	...
	{name: "CaptureBot", faction: "AncientRobot", clusterWith: "robot", playLine: "Robot", color: "#2a319c",
		...
		dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 5, noSummon: true}, {name: "KeyCard", weight: 1}, {name: "AncientPowerSourceSpent", weight: 1, noSummon: true}]},
	{name: "ForcefieldBot", faction: "AncientRobot", clusterWith: "robot", playLine: "Robot", color: "#2a319c",
		...
		dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 3, noSummon: true}, {name: "AncientPowerSourceSpent", weight: 1, noSummon: true}]},
	...
	{name: "BotMissile", faction: "AncientRobot", clusterWith: "robot", playLine: "Robot", color: "#2a319c",
		...
		dropTable: [{name: "Gunpowder", amountMin: 2, amountMax: 3, weight: 2, noSummon: true}, {name: "KeyCard", weight: 1}, {name: "AncientPowerSource", weight: 1, noSummon: true}]},
	{name: "EnforcerBot", faction: "AncientRobot", clusterWith: "robot", playLine: "Robot", color: "#2a319c",
		...
		dropTable: [{name: "KeyCard", weight: 1}, {name: "AncientPowerSource", weight: 1, noSummon: true}]},
	...
	{name: "SlimeAdv", faction: "Slime", clusterWith: "slime", bound: "SlimeAdv", playLine: "Gagged", color: "#FF00FF",
		...
		visionRadius: 4.5, blindSight: 2.5, maxhp: 10, minLevel:2, weight:0, movePoints: 1.7,
		attackPoints: 3, attack: "MeleeBindSlow", attackWidth: 1, attackRange: 1, power: 1, dmgType: "glue", fullBoundBonus: 2,
		terrainTags: {"latexAnger": 3, "latexRage": 3, "alchemist": 2, "slimeBonus": 2, "slime": 5, "lightslime": 2, "slimeOptOut": -5, "slimePref": 2, "jungle": 8, revenge: 10}, shrines: ["Latex"], allFloors: true,
		events: [
	...
	{name: "SmallSlime", clusterWith: "slime", faction: "Slime", color: "#FF00FF", tags: KDMapInit(["ignoretiedup", "disarmimmune", "blindimmune", "latexTrap", "minor", "slime", "melee", "slimeRestraints", "meleeresist", "chainimmune", "electricweakness", "acidresist", "iceweakness"]), squeeze: true, ignorechance: 0.75, followRange: 1, AI: "hunt",  sneakThreshold: 1,
		visionRadius: 3, blindSight: 2.5, maxhp: 3, minLevel: 0, maxLevel: 5, weight:0, movePoints: 1.5, attackPoints: 2, attack: "MeleeBindSuicideWill", suicideOnAdd: true, attackWidth: 1, attackRange: 1, power: 1, dmgType: "glue", fullBoundBonus: 2,
		Animations: ["squishy"],
		Sound: {
			baseAmount: 0,
			idleSoundName: "Slime",
		...
		terrainTags: {"increasingWeight":-1, "slime": 12, lightslime: 4, "slimeOptOut": -2, "slimePref": 2, "jungle": 20, "alchemist": 4}, allFloors: true, shrines: ["Latex"],
		events: [
			{trigger: "afterDamageEnemy", type: "bleedEffectTile", kind: "Slime", aoe: 1.5, power: 1, chance: 1.0, duration: 20},
		],},
	{name: "SmallSlimeLeaper", clusterWith: "slime", faction: "Slime", color: "#FF00FF", tags: KDMapInit(["ignoretiedup", "disarmimmune", "latexTrap", "minor", "slime", "melee", "slimeRestraints", "meleeresist", "chainimmune", "electricweakness", "acidresist", "iceweakness"]), squeeze: true, ignorechance: 0.75, followRange: 1, AI: "hunt",  sneakThreshold: 1,
		visionRadius: 4.5, blindSight: 2.5, maxhp: 3, minLevel: 5, weight:0, movePoints: 1.5, attackPoints: 2, attack: "MeleeBindSuicideWill", suicideOnAdd: true, attackWidth: 1, attackRange: 1, power: 1, dmgType: "glue", fullBoundBonus: 2,
		Animations: ["squishy"],
		Sound: {
			baseAmount: 0,
			moveAmount: 7,
		...
		terrainTags: {"increasingWeight":-1, "slime": 12, "slimeOptOut": -2, lightslime: 7, "slimePref": 2, "jungle": 20, "alchemist": 4}, allFloors: true, shrines: ["Latex"],
		events: [
			{trigger: "afterDamageEnemy", type: "bleedEffectTile", kind: "Slime", aoe: 1.5, power: 1, chance: 1.0, duration: 20},
		],},
	{name: "FastSlime", clusterWith: "slime", faction: "Slime", color: "#FF00FF", tags: KDMapInit(["ignoretiedup", "disarmimmune", "latexTrap", "slime", "melee", "slimeRestraints", "meleeresist", "chainimmune", "electricweakness", "acidresist", "iceweakness"]), squeeze: true, evasion: 0.3, followRange: 1, AI: "hunt",  sneakThreshold: 1,
		visionRadius: 4.5, blindSight: 2.5, maxhp: 3, minLevel: 9, weight:0, movePoints: 1, attackPoints: 3, attack: "MeleeBindSuicideWill", suicideOnAdd: true, attackWidth: 1, attackRange: 3, power: 2, dmgType: "glue", fullBoundBonus: 2,
		Animations: ["squishy"],
		Sound: {
			baseAmount: 0,
			idleSoundName: "Slime",
		...
		maxdodge: 2,
		dropTable: [{name: "SlimeRaw", amount: 1, weight: 10}],
		terrainTags: {"increasingWeight":1, "slime": 5.5, lightslime: 2, "slimeOptOut": -1.2, "slimePref": 1.2, "jungle": 8, "alchemist": 4}, allFloors: true, shrines: ["Latex"],
		events: [
			{trigger: "afterDamageEnemy", type: "bleedEffectTile", kind: "Slime", aoe: 1.5, power: 1, chance: 1.0, duration: 20},
		],},
	{name: "BigSlime", clusterWith: "slime", faction: "Slime", color: "#FF00FF", tags: KDMapInit(["ignoretiedup", "disarmimmune", "slime", "latexTrap", "elite", "melee", "slimeRestraints", "meleeresist", "chainimmune", "electricweakness", "acidresist", "iceweakness"]),
		...
		visionRadius: 4.5, blindSight: 2.5, maxhp: 12, minLevel: 9, weight:0, movePoints: 3, attackPoints: 3, attack: "MeleeBind",
		attackWidth: 3, attackRange: 1, power: 4, dmgType: "glue", fullBoundBonus: 2, disarm: 0.5,
		terrainTags: {"slime": 3.5, lightslime: 1, "alchemist": 3, "slimeOptOut": -1, "slimePref": 1}, allFloors: true, shrines: ["Latex"],
	...
	{name: "LatexCube", faction: "Latex", color: "#aa00cc",
		...
		visionRadius: 7.0, blindSight: 2.5, maxhp: 18, minLevel: 6, weight:0, movePoints: 4, attackPoints: 3, attack: "MeleeBind", attackWidth: 3, attackRange: 1, power: 4, dmgType: "glue", fullBoundBonus: 2, disarm: 0.7,
		terrainTags: {"slime": 3.5, "lightslime": 1.25, "plant": 2, "passage": 20, "open": -10, "slimeOptOut": -0.9, "slimePref": 1},
	...
	{name: "LatexCubeSmall", faction: "Latex", color: "#aa00cc",
		...
		visionRadius: 7.0, blindSight: 2.5, maxhp: 7, minLevel: 0, weight:0, movePoints: 2, attackPoints: 3, attack: "MeleeBindSuicide", attackWidth: 1, attackRange: 1, power: 2, dmgType: "glue", fullBoundBonus: 1, disarm: 0.2,
		suicideOnAdd: true, focusPlayer: true, multiBind: 3,
		terrainTags: {"slime": 4.5, lightslime: 1, "plant": 3, "passage": 30, "open": -10, "slimeOptOut": -1, "slimePref": 1}, allFloors: true, shrines: ["Latex"],
		events: [
			{trigger: "afterDamageEnemy", type: "bleedEffectTile", kind: "LatexThin", aoe: 1.5, power: 3, chance: 1.0, duration: 20},
			{trigger: "afterEnemyTick", type: "createEffectTile", kind: "LatexThin", time: 25, power: 2, chance: 0.5, aoe: 0.5},
		],
	...
	{name: "BarricadeAir", faction: "Elemental", color: KDBaseWhite,
		...
		visionRadius: 0, maxhp: 8, minLevel:0, weight:-10, movePoints: 99999, attackPoints: 4, attack: "MeleeEffect", attackWidth: 8, attackRange: 1, power: 2, dmgType: "stun",
		 allFloors: false, shrines: ["Elements"],
		events: [
	...
	{name: "GiantMushroom", faction: "Natural", clusterWith: "mushroom", tags: KDMapInit(["mushroom", "nofidget", "scenery", "nonvulnerable", "minor", "inactive", "harmless", "immobile", "unstoppable", "soulimmune", "slashweakness", "fireweakness", "glueresist", "poisonimmune", "coldweakness"]), spellResist: 0.33, sneakthreshold: 0.6,
		...
		visionRadius: 0, maxhp: 1, minLevel:0, weight:5, movePoints: 99999, attackPoints: 4, attack: "", attackWidth: 8, attackRange: 3, power: 1, dmgType: "souldrain",
		 floors:KDMapInit(["cry", "jngWild", "cav"]), shrines: ["Will"], ondeath: [{type: "spellOnSelf", spell: "Spores"}],
		Sound: {
			baseAmount: 0,
			moveAmount: 0,
			alertAmount: 0,
	...
	{name: "MushyHappy", clusterWith: "mushroom", color: "#4fa4b8", difficulty: 0.1,
		...
		visionRadius: 5, maxhp: 8, minLevel: 7, weight:14, movePoints: 4, attackPoints: 2, attack: "SpellMeleeWillBlind", blindTime: 2, attackWidth: 1, attackRange: 1, power: 4, dmgType: "tickle", 
		terrainTags: {"mushy": 10, "mushroomTrap": 50}, floors:KDMapInit(["cry"]), shrines: [], ondeath: [{type: "spellOnSelf", spell: "Spores"}],
		dropTable: [{name: "Gold", amountMin: 5, amountMax: 10, weight: 10}],
		stamina: 4,
		events: [
	...
	{name: "MaidKnightHeavy", nameList: "MaidKnightHeavy",
		...
		wanderAISetting: "Targeted",
		 shrines: ["Leather"], floors: {}, // Adventurers don't appear in lairs
	...
	{name: "Dryad", nameList: "elf", outfit: "Dryad", style: "Dryad", faction: "Elf", clusterWith: "nature", bound: "Dryad", playLine: "Dryad", color: "#67ff44", tags: KDMapInit(["opendoors", "nature", "elf", "leashing", "plant", "ranged", "vineRestraints", "slashweakness", "pierceweakness", "fireweakness", "search"]), cohesion: 0.0,
		...
		visionRadius: 6, maxhp: 10, minLevel:2, weight:-3, movePoints: 1.5, attackPoints: 3, attack: "SpellMeleeBind", attackWidth: 3, attackRange: 1, power: 2, dmgType: "tickle", fullBoundBonus: 2, 
	...
	{name: "JungleDryad", nameList: "elf", outfit: "Dryad", style: "Dryad", faction: "Enemy", clusterWith: "nature", bound: "JungleDryad", playLine: "Dryad", color: "#67ff44", tags: KDMapInit(["opendoors", "nature", "elf", "leashing", "plant", "ranged", "vineRestraints", "slashweakness", "pierceweakness", "fireweakness", "search"]), cohesion: 0.0,
		...
		maxdodge: 0,
		spells: ["PoisonDragonBlast", "EnemyCM1"], unlockCommandLevel: 1, unlockCommandCD: 90, spellCooldownMult: 1, spellCooldownMod: -2, tilesMinRange: 1, stopToCast: true, kite: 1.5,
		visionRadius: 6, maxhp: 10, minLevel:7, weight:5, movePoints: 1, attackPoints: 3, attack: "SpellMeleeBind", attackWidth: 3, attackRange: 1, power: 2, dmgType: "tickle", fullBoundBonus: 2, 
	...
	{name: "Cuffs", faction: "KinkyConstruct", clusterWith: "construct",
		tags: KDMapInit(["metalTrap", "doortrap", "ignoreharmless", "construct", "nosignal", "poisonimmune", "soulimmune", "melee",
			"cuffsSpell", "minor", "chainresist", "unarmedresist", "pierceresist", "slashresist", "glueweakness", "flying"]), ignorechance: 0.75,
		...
		nopickpocket: true,
		specialCD: 8, specialAttack: "DashBonus", specialRemove: "BindSuicide", specialCDonAttack: true, specialAttackPoints: 1, specialRange: 4.99, specialMinRange: 1.5, dashThrough: true, specialsfx: "Miss",
		visionRadius: 5, visionSummoned: 12, maxhp: 1, minLevel: 0, weight:0, movePoints: 1, attackPoints: 2, attack: "MeleeBindSuicide", suicideOnAdd: true, attackWidth: 1, attackRange: 1, power: 1, dmgType: "charm", fullBoundBonus: 1,
	...
	{name: "Feathers", faction: "KinkyConstruct", clusterWith: "construct", tags: KDMapInit(["ignorenoSP", "construct", "nosignal", "poisonresist", "soulimmune", "melee", "chainRestraints", "minor", "firesevereweakness", "meleeresist", "doortrap", "flying"]), ignorechance: 0.75, armor: -1, followRange: 1, AI: "hunt",  ignoreflag: ["feathers"], failAttackflag: ["feathers"], squeeze: true,
		...
		terrainTags: {"secondhalf":2, "lastthird":-1, "increasingLevel": -0.25, revenge: 7, "Less_Tickle": -10, "doortrap": 8}, allFloors: true, shrines: [], difficulty: 0.7, },
	...
	{name: "ElementalRubber", outfit: "ElementalRubber", style: "EarthElemental", faction: "Elemental", playLine: "Elemental", clusterWith: "Elemental", bound: "ElementalRubber", squeeze: true,
		...
		terrainTags: {"secondhalf":2, "thirdhalf":1, "latexAnger": 4, "latexRage": 4, "latexPleased": 2, "latexFriendly": 3,
			lightslime: 2.5, "temple": 8, "doortrap":5, revenge: 5, "alchemist": 5, "latex": 5, "slime": 5}, allFloors: true, shrines: ["Latex", "Elements"],
		events: [
			{trigger: "afterEnemyTick", type: "createEffectTile", kind: "LatexThinBlue", time: 4, power: 1, chance: 0.5, aoe: 0.5},
			{trigger: "afterDamageEnemy", type: "bleedEffectTile", kind: "LatexThinBlue", aoe: 1.5, power: 1, chance: 1.0},
		],
	...
	{name: "ApprenticeSlime", nameList: "witch", outfit: "ApprenticeSlime", style: "Necromancer", faction: "Apprentice", color: "#FF00FF", bound: "ApprenticeSlime", playLine: "Apprentice",
		...
		spellCooldownMult: 1, spellCooldownMod: 0, AI: "hunt", guardChance: 0.6, visionRadius: 5, maxhp: 8, minLevel:2, weight:0, movePoints: 2, attackPoints: 3, attack: "SpellMeleeBindLock", attackWidth: 1, attackRange: 1, power: 1, dmgType: "grope", fullBoundBonus: 1,
		terrainTags: {"secondhalf":3, lightslime: 4, "lastthird":3, "increasingWeight": -1, "apprentice": 4, "slime": 12, "slimeOptOut": -6, "slimePref": 2, "magical": 4}, allFloors: true, shrines: ["Latex"],
		attackLock: "White",
		stamina: 2,
		maxblock: 0,
		maxdodge: 0,
	...
	{name: "WitchShibari", nameList: "witch", outfit: "Bikini", style: "Earth", color: "#ffae70", faction: "Witch", clusterWith: "apprentice", bound: "WitchRope",
		...
		spellCooldownMult: 0.7, spellCooldownMod: 0, AI: "hunt", guardChance: 0.2, visionRadius: 7, maxhp: 12, minLevel:2, weight:1, movePoints: 2.2, attackPoints: 2,
		attack: "EffectSpellMeleeBind", attackWidth: 2.5, attackRange: 1, power: 3, dmgType: "charm", fullBoundBonus: 3,
	...
	{name: "WitchWater", nameList: "witch", outfit: "WitchWater", style: "Water", faction: "Witch", clusterWith: "elemental", bound: "WitchWater", playLine: "Witch", color: "#4572e3", tags: KDMapInit(["leashing", "mage", "guardCall", "jailer", "opendoors", "imprisonable", "handcuffer", "water", "closedoors", "human", "witch", "ranged", "elite", "unflinching", "fireresist", "acidresist", "soapresist", "electricsevereweakness", "pierceresist", "hunter", "latexRestraints"]), followRange: 1,
		...
		terrainTags: {"secondhalf":1, "lastthird":2, "elementsAnger": 6, "bubbleOptout": -2, "tech": -6, "water": 6, "ice": 2}, allFloors: true, shrines: [], followLeashedOnly: true,
		attackLock: "White",
		stamina: 2,
		maxblock: 0,
		maxdodge: 2,
	...
	{name: "WitchSlime", nameList: "witch", outfit: "WitchSlime", style: "Necromancer", faction: "Witch", clusterWith: "slime", bound: "WitchSlime", playLine: "Witch",
		...
		spellCooldownMult: 2, spellCooldownMod: -7, AI: "hunt", guardChance: 0.6, visionRadius: 8, maxhp: 13, minLevel:3, weight:0, movePoints: 3, attackPoints: 3, attack: "Spell", attackWidth: 1, attackRange: 1, power: 1, dmgType: "grope", fullBoundBonus: 1,
		attackLock: "Purple",
		maxblock: 0,
		maxdodge: 2,
		terrainTags: {"secondhalf":2, "lastthird":1, "bubbleOptout": -3.5, "bubblePref": 2, "open": 4, "tech": -8, lightslime: 2, "slime": 6, "slimeOptOut": -4, "slimePref": 2}, allFloors: true, shrines: [],
		events: [
	...
	{name: "Chef", nameList: "italian", outfit: "Chef", style: "Fire", bound: "Jailer", tags: KDMapInit(["leashing", "ignoregagged", "opendoors", "closedoors", "melee", "ballGagRestraintsMagic"]), followRange: 1, AI: "hunt",
		...
		attackPoints: 2, attack: "MeleeBind", attackWidth: 2.5, attackRange: 1, power: 3, dmgType: "grope", fullBoundBonus: 2,
		 allFloors: true, disarm: 0.33, evasion: -0.5, focusPlayer: true,
		useLock: "Blue",
	...
	// Bosses
	{name: "Fuuka1", recruitType: "FuukaRecruit", outfit: "Fuuka", style: "Fuuka", nameList: "Fuuka", playLine: "Fuuka", bound: "Fuuka", faction: "Boss", clusterWith: "zombie", tags: KDMapInit(["nosub", "nocapture", "leashing", "noshop", "fuuka", "zombie", "ranged", "mikoRestraints", "stageBoss", "boss", "nocapture", "unflinching"]),
		...
		attackLock: "White",
		 floors:KDMapInit([]), dropTable: [{name: "Scrolls", weight: 10}], ondeath: [{type: "bossstage", dialogue:"FuukaStage2", click: true}]},
	{name: "Fuuka2", recruitType: "FuukaRecruit", outfit: "Fuuka", style: "Fuuka", nameList: "Fuuka", playLine: "Fuuka", bound: "Fuuka", faction: "Boss", clusterWith: "zombie",
		...
		attackLock: "Purple",
		 floors:KDMapInit([]), dropTable: [{name: "BlueKey", weight: 10}], ondeath: [{type: "dialogue_and_die", dialogue:"FuukaWin", click: true}]},
	...
	{name: "FuukaRecruit", outfit: "Fuuka", style: "Fuuka", nameList: "Fuuka", playLine: "Fuuka", bound: "Fuuka", clusterWith: "zombie",
		...
		attackLock: "Purple",
		 floors:KDMapInit([]), dropTable: [{name: "BlueKey", weight: 10}]},
	...
	{name: "MikoGhost", faction: "Ghost", color: KDBaseWhite, clusterWith: "ghost",
		...
		visionRadius: 30, blindSight: 30, evasion: 9.0, alwaysEvade: true, maxhp: 1, regen: -0.051, minLevel:0, weight:-1000, movePoints: 2, attackPoints: 1, attack: "MeleeWill", attackWidth: 3, attackRange: 1, power: 1, dmgType: "grope", fullBoundBonus: 0,
		 shrines: ["Illusion"], floors:KDMapInit([]), dropTable: [{name: "Ectoplasm", chance: 0.6, weight: 10}],},
	...
	{name: "TheWarden1", recruitType: "TheWardenRecruit", outfit: "Jailer", style: "Jailer", nameList: "TheWarden", playLine: "TheWarden", bound: "TheWarden", faction: "Boss", clusterWith: "human",
		color: "#ffaa44",
		...
		attackLock: "Purple",
		 floors:KDMapInit([]), dropTable: [{name: "Scrolls", weight: 10}], ondeath: [{type: "bossstage", dialogue:"TheWardenStage2", click: true}]},

	{name: "TheWarden2", recruitType: "TheWardenRecruit", outfit: "Jailer", style: "Jailer", nameList: "TheWarden", playLine: "TheWarden", bound: "TheWarden", faction: "Boss", clusterWith: "human",
		color: "#ffaa44",
		...
		attackLock: "HiSec",
		 floors:KDMapInit([]), dropTable: [{name: "Scrolls", weight: 10}], ondeath: [{type: "dialogue_and_die", dialogue:"TheWardenWin", click: true}]},
	...
	{name: "TheWardenRecruit", outfit: "Jailer", style: "Jailer", nameList: "TheWarden", playLine: "TheWarden", bound: "TheWarden", clusterWith: "human",
		...
		attackLock: "HiSec",
		 floors:KDMapInit([]), dropTable: [{name: "Scrolls", weight: 10}]},

	{name: "DollmakerBoss1", recruitType: "DollmakerRecruit", outfit: "DollSuit", playLine: "Dollmaker", bound: "DollmakerBoss", faction: "Boss", clusterWith: "dollsmith",
		applyFaction: "Dollsmith",
	...
	{name: "DollmakerBoss2", recruitType: "DollmakerRecruit", outfit: "DollSuit", playLine: "Dollmaker", bound: "DollmakerBoss", faction: "Boss", clusterWith: "dollsmith",
		applyFaction: "Dollsmith",
		tags: KDMapInit(["nosub", "leashing", "noshop", "dollsmith", "ranged", "nocapture", "slimewalk",
			"bulwark",
	...
	{name: "DollmakerBoss3", recruitType: "DollmakerRecruit", nameList: "Dollmaker", outfit: "Dollmaker", style: "Dollmaker", playLine: "Dollmaker", bound: "DollmakerBoss", faction: "Boss", clusterWith: "dollsmith",
		applyFaction: "Dollsmith",
	...
	{name: "DollmakerRecruit", nameList: "Dollmaker", outfit: "Dollmaker", style: "Dollmaker", playLine: "Dollmaker", bound: "DollmakerBoss", clusterWith: "dollsmith",
		...
		tags: KDMapInit(["nosub", "leashing", "noshop", "dollsmith", "ranged", "slimewalk",
			"bulwark",
			"glueresist", "electricresist", "crushresist", "iceweakness", "dollmakerrestraints", "cyberdollchastity", "cyberdollrestraints", "cyberdollheavy", "controlharness", "teasetoys", "unstoppable", "stageBossRecruit"]),
		spellResist: 2.0, armor: 0.5, followRange: 1.5, AI: "guard",
		events: [
			{trigger: "getLights", type: "enemyTorch", power: 3.5, color: "#ff88ff"},
		],
		...
		if (mapData == KDMapData) {
			...
			for (let en of e) {
				if (!f) {
					...
					f.CustomPronoun = enemy.CustomPronoun;
