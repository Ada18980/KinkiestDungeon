...
let KinkyDungeonEnemies: enemy[] = [
	...
	{name: "OldDrone", faction: "Enemy", clusterWith: "robot", playLine: "Robot", noChaseUnrestrained: true,
		...
		visionRadius: 7, followRange: 1, projectileAttack: true, useLock: KDBaseWhite, followLeashedOnly: true,
	...
	{name: "DragonCrystal", nameList: "dragonheart", outfit: "DragonCrystal", style: "Water", faction: "Dragon", clusterWith: "dragon", bound: "DragonCrystal", color: "#ff00aa",
		...
		attackLock: KDBaseWhite, maxdodge: 0,
		stamina: 5,
		preferBlock: true,
	...
	{name: "WitchShock", nameList: "witch", outfit: "WitchShock", style: "Air", faction: "Witch", clusterWith: "apprentice", bound: "Witch", playLine: "Witch",
		...
		dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 14, noSummon: true}], attackLock: KDBaseWhite,
		maxblock: 0,
		maxdodge: 1,
		events: [
	...
	{name: "Necromancer", nameList: "chinese", outfit: "Necromancer", style: "Necromancer", faction: "Enemy", clusterWith: "skeleton", bound: "Necromancer", playLine: "Necromancer",
		...
		terrainTags: {"secondhalf":3, "lastthird":3, "miniboss": -7, "tech": -20, "velvet": 4, "skeleton": 3}, shrines: [], floors:KDMapInit(["cat", "jng", "tmb", "tmp"]), attackLock: KDBaseWhite,
		dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 14, noSummon: true}]},
	...
	{name: "Nurse", outfit: "Nurse", style: "Earth", clusterWith: "construct", bound: "Nurse", playLine: "Nurse", faction: "Dressmaker", color: "#f135a4",
		...
		attackWidth: 1, attackRange: 1, power: 3, dmgType: "charm", fullBoundBonus: 3, focusPlayer: true, attackLock: KDBaseWhite,
	...
	{name: "Jailer", outfit: "Jailer", style: "Earth", bound: "Jailer", tags: KDMapInit(["leashing", "opendoors", "closedoors", "antiMagic", "jail", "jailer", "genericJailer", "melee", "shackleRestraints", "guardCall", "jailRestraints"]), keys: true, followRange: 1, AI: "patrol",
		...
		maxblock: 1,
		maxdodge: 0,
		terrainTags: {"jailGuard": 15, "Guard": 1}, allFloors: true, disarm: 0.5, evasion: -0.5, focusPlayer: true, attackLock: KDBaseWhite,
	...
	{name: "Guard", outfit: "Jailer", style: "Ice", bound: "Guard", tags: KDMapInit(["leashing", "opendoors", "closedoors", "antiMagic", "miniboss", "jail", "jailer", "melee", "shackleRestraints", "jailRestraints", "guardCall"]), noDisplace: false, keys: true, followRange: 1, AI: "guard", visionRadius: 6, disarm: 0.5,
		...
		fullBoundBonus: 2, evasion: -0.5, focusPlayer: true, attackLock: KDBaseWhite,
		stamina: 2,
		maxblock: 1,
		maxdodge: 0,
		RemoteControl: {
