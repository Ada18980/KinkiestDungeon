...
let KinkyDungeonWeapons: Record<string, weapon> = {
	...
	"StormBreaker": {name: "StormBreaker", damage: 2.0, chance: 1.0, staminacost: 2.6, type: "crush", unarmed: false, rarity: 5, magic: true, shop: false, sfx: "HeavySwing",
		...
		clumsy: true,
		events: [
			{type: "Buff", kind: "Weapon", trigger: "tick", power: 1.0, buffType: "electricDamageResist", offhand: true},
	...
	"Sweeper": {name: "Sweeper", damage: 2.5, chance: 1.0,
		staminacost: 3.2, type: "slash", unarmed: false, rarity: 7,
