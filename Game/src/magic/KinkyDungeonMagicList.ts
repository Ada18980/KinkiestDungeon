...
let KinkyDungeonSpellListEnemies: spell[] = [
	...
	{enemySpell: true, name: "WitchRopeBoltLaunchMany", tags: ["rope", "bolt", "binding", "offense"], prerequisite: "RopeBoltLaunch", sfx: "MagicSlash", school: "Conjure",
		...
		noSprite: true,
		manacost: 5, components: ["Verbal"], projectileTargeting: true, CastInWalls: true, level:1, type:"inert", onhit:"aoe", time: 5, delay: 3, power: 1, range: 7, meleeOrigin: true, noDirectionOffset: true, size: 1, lifetime: 1, damage: "inert", noMiscast: false, castDuringDelay: true, noCastOnHit: true,
		followCaster: true,
	...
	{name: "Icicle", sfx: "MagicSlash", hitsfx: "Freeze", school: "Elements", manacost: 5, components: ["Arms"], level:1, type:"bolt", projectileTargeting:true, onhit:"", time: 4,
		...
		bulletColor: 0x92e4e8, bulletLight: 3,
		events: [{type: "ElementalOnSlowOrBindOrDrench", trigger: "bulletHitEnemy", damage: "ice", time: 3, power: 0},]},
	{name: "Boulder", sfx: "Bones", hitsfx: "Clang", school: "Elements", manacost: 3, components: ["Arms"], level:1,
		noise: 5,
	...
	{allySpell: true, name: "BoulderKicked", sfx: "Bones", hitsfx: "Clang", school: "Elements", manacost: 3, components: ["Arms"], level:1, type:"bolt", projectileTargeting:true, onhit:"", time: 4,  power: 4, delay: 0, range: 50, damage: "crush", speed: 3.5, playerEffect: {name: "Damage"}}, // Throws a blast of ice which stuns the target for 4 turns
	{name: "BigBoulder", sfx: "Bones", hitsfx: "ClangDeep", school: "Elements", manacost: 7, components: ["Arms"], level:1, type:"bolt", noDirectDamage: true,
		noise: 7,
	...
	{enemySpell: true, name: "OneBarMissile",
		...
		speed: 0.5, playerEffect: {name: "WardenOrb", damage: "pierce", power: 7.2, tag: "onebar"}},
	{enemySpell: true, name: "SummonOneBar", noSprite: true, minRange: 0, manacost: 2, specialCD: 12,
		...
		effectTileAoE: 1.5,
		components: ["Verbal"], level:4, type:"hit", onhit:"summon", summon: [{name: "OneBar", faction: "Warden", count: 1, time: 0, bound: true}], power: 0, time: 10, delay: 0, range: 40, size: 1, aoe: 0.5, lifetime: 1, damage: "inert"},
	...
	{enemySpell: true, faction: "Trap", name: "SpikeTrap", sfx: "SpikeTrapTrigger", hitsfx: "SpikeTrapHit",
		...
		noTerrainHit: true, time: 5, delay: 2, power: 6, range: 2, size: 3, aoe: 1.5,
		bind: 10,
		bindType: "Furniture",
