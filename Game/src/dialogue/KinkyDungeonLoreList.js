...
KDNewLore(["Default", 'cat'], "CathCat2", "Willows 19",
...
KDNewLore(["Default", 'cat'], "CathCat2", "Willows 20",
...
KDNewLore(["Default", 'cat'], "CathCat3", "Willows 21",
...
KDNewLore(["Default", 'cat', 'lib'], "CathLib1", "Willows 30",
...
KDNewLore(["Default", 'lib'], "CathLib2", "Willows 31",
...
KDNewLore(["Default", 'lib'], "CathLib4", "Willows 41",
...
KDNewLore(["Default", 'lib'], "CathLib5", "Willows 42",
	"Catherine Willows' Journal (pg. 42)",
	"I must find it.|They are looking for it.|They CANNOT be allowed to have it.",
	undefined, undefined, ['Default'],
);

KDNewLore(["Default", 'jng', 'cry'], "CathJng1", "Willows 50",
...
KDNewLore(["Default", 'jng'], "CathJng2", "Willows 51",
...
KDNewLore(["Default", 'jng', 'cry'], "SW1", "Silver 1",
	"Silver Witch's Notes #1",
	"It seems I am not alone in my search for the Staff. To whom it may concern: the Greak Work is a lie, and it will doom us all. If you care for your soul, you need to break the cycle, and for that we need a key: the Mistress' Staff.",
	undefined, undefined, ['Default', 'cry'],
);
