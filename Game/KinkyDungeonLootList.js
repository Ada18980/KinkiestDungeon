...
let KinkyDungeonLootTable = {
	...
	"chest": [
		...
		{name: "Breastplate", minLevel: 0, weight:0.5,
			armor: "Breastplate",
			norestraint: ["Breastplate"], message:"LootChestArmor", messageColor:"lightblue", messageTime: 3, allFloors: true},
		{name: "Breastplate_Cursed", minLevel: 0, weight:0.3,
			armor: "Breastplate",
			curses: [...KinkyDungeonGetCurses("Breastplate")], unlockcurse: [...KDBasicCurseUnlock],
			norestraint: [...KinkyDungeonGetCurses("Breastplate", true)], message:"LootChestArmor", messageColor:"lightblue", messageTime: 3, allFloors: true},
		{name: "Bracers", minLevel: 0, weight:0.5,
			armor: "Bracers",
			norestraint: ["Bracers"], message:"LootChestArmor", messageColor:"lightblue", messageTime: 3, allFloors: true},
		{name: "Bracers_Cursed", minLevel: 0, weight:0.3,
			armor: "Bracers",
			curses: [...KinkyDungeonGetCurses("Bracers")], unlockcurse: [...KDBasicCurseUnlock],
			norestraint: [...KinkyDungeonGetCurses("Bracers", true)], message:"LootChestArmor", messageColor:"lightblue", messageTime: 3, allFloors: true},
		{name: "LeatherBoots", minLevel: 0, weight:0.5,
			armor: "LeatherBoots",
			norestraint: ["LeatherBoots"], message:"LootChestArmor", messageColor:"lightblue", messageTime: 3, allFloors: true},
		{name: "LeatherBoots_Cursed", minLevel: 0, weight:0.3,
			armor: "LeatherBoots",
			curses: [...KinkyDungeonGetCurses("LeatherBoots")], unlockcurse: [...KDBasicCurseUnlock],
			norestraint: [...KinkyDungeonGetCurses("LeatherBoots", true)], message:"LootChestArmor", messageColor:"lightblue", messageTime: 3, allFloors: true},
