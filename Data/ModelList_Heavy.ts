...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "LegLegbinder", Layer: "WrappingLegs", Pri: -20,
			Poses: ToMap(["Closed", "KneelClosed", "Hogtie"]),
			GlobalDefaultOverride: ToMap(["KneelClosed", "Hogtie"]),
			InheritColor: "Binder",
		},
		{ Name: "RightLegbinder", Layer: "WrappingLegsRightOver", Pri: -20,
			Poses: ToMap(["Closed", "KneelClosed", "Hogtie"]),
			GlobalDefaultOverride: ToMap(["KneelClosed", "Hogtie"]),
			InheritColor: "Binder",

		},
		{ Name: "LegRightLegbinder", Layer: "WrappingLegsRight", Pri: -20,
