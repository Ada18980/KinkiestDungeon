...
AddModel({
	...
	Restraint: true,
	Categories: ["Restraints", "Jacket", "Leather"],
	AddPose: ["EncaseTorsoUpper", "EncaseChest", "CrotchStrap"],
	Layers: ToLayerMap([
...
AddModel({
	...
	Restraint: true,
	Categories: ["Restraints", "Jacket", "Leather"],
	AddPose: ["EncaseTorsoUpper", "EncaseChest", "HideHands", "CrotchStrap"],
	Layers: ToLayerMap([
...
AddModel({
	...
	Restraint: true,
	AddPose: ["HideHands"],
	Categories: ["Restraints", "Jacket", "Leather", "CrotchStrap"],
	Layers: ToLayerMap([
