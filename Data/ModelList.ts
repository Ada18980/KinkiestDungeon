...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "ShirtChest", Layer: "BraChest", Pri: 5,
			Poses: ToMap([...ARMPOSES, "Hogtie"]),
			MorphPoses: {Hogtie: "Hogtie"},
			InheritColor: "Shirt",
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "SkirtOver", Layer: "Skirt", Pri: 7,
			Poses: ToMap([...KNEELPOSES]),
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "BlouseBust", Layer: "BraChest", Pri: 3,
			Poses: ToMap([...ARMPOSES]),
			HideWhenOverridden: true,
			InheritColor: "Blouse",
			HidePrefixPose: ["Encase"],	HidePrefixPoseSuffix: ["TorsoUpper"],
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "BlouseBust", Layer: "BraChest", Pri: 4,
			Poses: ToMap([...ARMPOSES]),
			HideWhenOverridden: true,
			InheritColor: "Blouse",
			HidePrefixPose: ["Encase"],	HidePrefixPoseSuffix: ["TorsoUpper"],
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "SkirtOver", Layer: "SkirtPoofyLeftLeg", Pri: 14,
			Poses: ToMap([...KNEELPOSES]),
			HideWhenOverridden: true,
			AppendPose: ToMapDupe(["CrotchStrap"]),
			InheritColor: "Skirt",
		...
		{ Name: "SkirtRuffleOver", Layer: "SkirtPoofyLeftLeg", Pri: 14.1,
			Poses: ToMap([...KNEELPOSES]),
			TieToLayer: "SkirtOver", NoOverride: true,
			AppendPose: ToMapDupe(["CrotchStrap"]),
			InheritColor: "Skirt",
			HidePrefixPose: ["Encase"],	HidePrefixPoseSuffix: ["TorsoLower"],
			//Invariant: true,
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "BustierChest", Layer: "BraChest", Pri: 15,
			Invariant: true,
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "SkirtOver", Layer: "SkirtPoofy", Pri: 7,
			Poses: ToMap([...KNEELPOSES]),
			//RequirePoses: ToMap(["CrotchStrap"]),
			TieToLayer: "Skirt", NoOverride: true,
			AppendPose: ToMapDupe(["CrotchStrap"]),
