...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "CorsetGarterLeftBack", Layer: "BehindTorso", Pri: -25,
			...
			AppendPose: {"HiSecGarter": "Garter"},
			MorphPoses: {Kneel: "Kneel", KneelClosed: "Kneel", Closed: "Closed", Hogtie: "Closed"},
			SwapLayerPose: {"HiSecGarter": "OverGarters"},
		},
		...
		{ Name: "CorsetHardwareGarterLeft", Layer: "OverGarters", Pri: 24.95,
			Invariant: true,
		...
		{ Name: "CorsetHardwareGarterRight", Layer: "OverGarters", Pri: 24.95,
			Invariant: true,
