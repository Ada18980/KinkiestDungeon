...
AddModel({
	...
	Restraint: true,
	AddPose: ["HideArms", "EncaseArmLeft", "EncaseArmRight", "EncaseLegs", "ForceKneel"],
	...
	Layers: ToLayerMap([
		...
		{ Name: "LegsBelts", Layer: "WrappingLegs", Pri: -5.1,
			TieToLayer: "Legs",
			NoOverride: true,
			Poses: ToMap(["KneelClosed", "Kneel", "Hogtie"]),
			GlobalDefaultOverride: ToMap(["KneelClosed", "Hogtie"]),
		},
		{ Name: "LeftLegs", Layer: "WrappingLegs2", Pri: -5,
			Poses: ToMap(["KneelClosed", "Kneel"]),
			GlobalDefaultOverride: ToMap(["KneelClosed"]),
			InheritColor: "Legs",
		},
		{ Name: "LeftLegsBelts", Layer: "WrappingLegs2", Pri: -5.1,
			TieToLayer: "LeftLegs",
			NoOverride: true,
			Poses: ToMap(["KneelClosed", "Kneel"]),
			GlobalDefaultOverride: ToMap(["KneelClosed"]),
