...
AddModel({
	...
	AddPose: ["ThighLink"],
	Layers: ToLayerMap([
		{ Name: "ThighLink", Layer: "BindChainLinksUnder", Pri: 5.1,
			Poses: ToMap(["Spread"]),
			AppendPose: {"HighCuffs": "High"}, // "LowCuffs": "",
			InheritColor: "Tether",
			HideWhenOverridden: true,
		},
		{ Name: "GlowThighLink", Layer: "BindChainLinksUnder", Pri: 5,
			Poses: ToMap(["Spread"]),
			AppendPose: {"HighCuffs": "High"}, // "LowCuffs": "",
...
AddModel({
	...
	AddPose: ["AnkleLink"],
	Layers: ToLayerMap([
		{ Name: "AnkleLink", Layer: "BindChainLinksUnder", Pri: 5.1,
			Poses: ToMap(["Spread"]),
			InheritColor: "Tether",
			HideWhenOverridden: true,
		},
		{ Name: "GlowAnkleLink", Layer: "BindChainLinksUnder", Pri: 5,
			Poses: ToMap(["Spread"]),
