...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "Inner1Right", Layer: "AnimalEarsFront", Pri: 10.1,
			Invariant: true,
		...
		{ Name: "Ear1Left", Layer: "AnimalEarsFront", Pri: 10,
			Invariant: true,
			OffsetY: -160,
			InheritColor: "Ears",
		},
		{ Name: "Inner1Left", Layer: "AnimalEarsFront", Pri: 10.1,
			Invariant: true,
			TieToLayer: "Ear1Left",
			NoOverride: true,
			OffsetY: -160,
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "HalfFlopInner1Right", Layer: "AnimalEarsFront", Pri: 10.1,
			Invariant: true,
			TieToLayer: "Ear1Right",
			NoOverride: true,
			OffsetY: -160,
		...
		{ Name: "HalfFlopEar1Left", Layer: "AnimalEarsFront", Pri: 10,
			Invariant: true,
			OffsetY: -160,
			InheritColor: "Ears",
		},
		{ Name: "HalfFlopInner1Left", Layer: "AnimalEarsFront", Pri: 10.1,
			Invariant: true,
			TieToLayer: "Ear1Left",
			NoOverride: true,
			OffsetY: -160,
...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "FlopInner1Right", Layer: "AnimalEarsFront", Pri: 10.1,
			Invariant: true,
			TieToLayer: "Ear1Right",
			NoOverride: true,
			OffsetY: -160,
		...
		{ Name: "FlopEar1Left", Layer: "AnimalEarsFront", Pri: 10,
			Invariant: true,
			OffsetY: -160,
			InheritColor: "Ears",
		},
		{ Name: "FlopInner1Left", Layer: "AnimalEarsFront", Pri: 10.1,
			Invariant: true,
			TieToLayer: "Ear1Left",
			NoOverride: true,
			OffsetY: -160,
